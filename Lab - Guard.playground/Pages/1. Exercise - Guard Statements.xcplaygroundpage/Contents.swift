...
print(calculateArea(x: 3.5, y: 4.2))
...
func createUser() -> User?{
    guard let firstNameTextField.text = firstNameTextField.text, lastNameTextField.text = lastNameTextField.text, ageTextField.text = ageTextField.text else{
        return nil
    }
}
